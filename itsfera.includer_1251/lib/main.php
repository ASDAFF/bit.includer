...
class Main{
    ...
    const NEWS_LIST_TEMPLATE = "itsfera.includer";
    const DETAIL_TEMPLATE = "itsfera.includer";
    ...
    public static function makeList( $iSectionId )
    {
        ...
        $iIblockId =  \COption::GetOptionString("itsfera.includer", "iblock_id", false);
        $iIblockType =  \COption::GetOptionString("itsfera.includer", "iblock_type", "") ;

        $rsEvents = GetModuleEvents("itsfera.includer", "OnBeforeMakeList");
    ...
    public static function makeDetail( $iPhotoId )
    {
        ...
        $iIblockId =  intval( \COption::GetOptionString("itsfera.includer", "iblock_id", 0) );
        $iIblockType =  \COption::GetOptionString("itsfera.includer", "iblock_type", "") ;

        $rsEvents = GetModuleEvents("itsfera.includer", "OnBeforeMakeDetail");
        if ($arEvent = $rsEvents->Fetch()){
